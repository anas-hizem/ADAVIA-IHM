...
Rectangle {
    ...
    Rectangle {
        ...
        width: foreground.implicitWidth - 100
        height: foreground.implicitHeight - 80
        RowLayout {
            id: wrapper
            anchors.fill: parent
            spacing: 40
            ...
            Rectangle {
                ...
                BorderImage {
                    ...
                    Image {
                        id: coverPic
                        source: player.metaData.coverArtUrlLarge ? player.metaData.coverArtUrlLarge : "assets/spotifyimg.png"
                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                id: trackAlbum
                                text: player.metaData.albumTitle ? player.metaData.albumTitle : "Song album unavailable"
                                color: "steelblue"
                                font.family: appFont.name
                                font.pointSize: 12
                                font.bold: true
